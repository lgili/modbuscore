...
/**
 * @brief Calculates the CRC for Modbus communication.
 *
...
/**
 * @brief Calculates the CRC using the precomputed CRC table.
 *
 * @param data   Pointer to the data buffer.
 * @param length Length of the data.
 * @return uint16_t Calculated CRC value.
...
/* @brief        Calculate checksum for bootloader communication.
 *
 * This function calculates a simple checksum by subtracting each byte of the serial data.
 *
 * @param        p_serial_data   Pointer to the serial data buffer.
